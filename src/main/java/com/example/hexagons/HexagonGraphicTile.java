...
public class HexagonGraphicTile extends Polygon {
    ...
    public void setHigherLeftButton(double x, double y, int j, int i,Tile tile) {
    ...
    public void setLowerLeftButton(double x, double y, int j, int i,Tile tile) {
    ...
    public void setCoordinates(double x, double y, int j, int i) {
